    ...
    <div class="container w-100">
      ...
      <!-- end banner -->
        ...
        <section class="mt-5 remove-margin center">
            ...
            <h3 style="font-size: 20px;">Easy Park is one of secure Parking spots in Colombo in affordable for all classes.</h3>
            ...
            <section class="mt-5" id="gallery">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="master-parking borderrr text-center">Gallery</h3>
                        <div id="lb-back">
                            <div id="lb-img"></div>
                        </div>
