...
<head>
  <title>Easy Park Admin Portal</title>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="../easy park/assets/css/style.css">
    ...
    <div class="row" id="fixed-sidebar">
        <div class="sidebar col-sm-3 col-md-5" id="fixed-sidebar">
            <ul class="custom-list"><br><br>
                ...
                <li><a href="dashboard.php?option=Parking_details" id="list-color">Parking Details</a></li><br><br>
                <li><a href="#" id="list-color">Payment Details</a></li><br><br>
                <li><a href="#" id="list-color">Users</a></li><br><br>
                <li><a href="#" id="list-color">Vehicles</a></li><br><br>
            </ul>
        </div>
      ...
      <div class="col-sm-9 col-sm-offset-5 col-md-7 col-md-offset-3 main" >
        ...
        if ($opt == "") {
          ...
          }else if ($opt == "Parking_details") {
            include('parking_management.php');
          } 
